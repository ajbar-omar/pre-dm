...
open class MyAdapter (var ctx:Context, var ressource:Int, var items:ArrayList<User>) : ArrayAdapter<User>(ctx,ressource,items) {
    ...
    fun deleteUser(id:Int){
        val url="http://172.16.1.57/API%20PHP/Operations/CRUD/Delete.php?id="+id
