...
class updateUser : AppCompatActivity() {
    ...
    lateinit var payement:EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        payement = findViewById(R.id.editePayment)
        ...
        btn.setOnClickListener{
            if(checkInternet()) Save(id,username.text.toString(),email.text.toString(),payement.text.toString())
    ...
    private fun Afficher(id : Int){
        val url="http://172.16.1.57/API%20PHP/Operations/CRUD/Read.php?id="+id
        ...
        val jor= JsonObjectRequest(Request.Method.POST,url,jO, Response.Listener { res->
            try {
                if(res.getString("success").equals("1")){
                    ...
                    payement.setText(data.getString("Password").toString())
    ...
    private fun Save(id:Int,username:String,email:String,payement:String){
        val url="http://172.16.1.57/API%20PHP/Operations/CRUD/Update.php"
        val params=HashMap<String,String>()
        params["id"]= ""+id
        params["username"]=username
        params["email"]=email
        params["Password"]=payement
